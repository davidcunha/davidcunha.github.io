    ...
    <div id="main">
      ...
      <div className="inner">
        ...
        <div className="quote">
          <blockquote>
            ...
            that I could go on with words to describe him. Amazing talented
        ...
        <div className="quote">
          <blockquote>
            ...
            to work with him. Besides being objective and very pragmatic, he is
            not satisfied with any solution, but the right one(the right tool,
            for the job). Besides this, the fact of being a good colleague,
            makes a painful job, a more enjoyable experience. Would really like
            to have the opportunity to work with him full time.”
          </blockquote>
          <div className="author">
      ...
      <div className="inner">
        ...
        <p>
          ...
          because my foundations weren’t rock-solid at a time the team needed me
          for delivering high-quality code.
        </p>
        <p>And my dear friends, this feeling can hit you hard...</p>
        <p>
          So I spent years reading books, networking with other developers, and
          most importantly coding different type of projects from frontend to
          backend and distributed computing, while I was working in several
          companies.
        </p>
        <p>
        ...
        <p>
          I joined web product development agencies where I had the opportunity
          to meet founders from Startups that aimed to build sustainable
          businesses from their dreams. Back in the day,{' '}
          <strong>
            <a
          ...
          performance requirements and deadlines. I was really into the RoR and{' '}
          <strong>Ruby</strong> community, that I participated in conferences,
          Slack groups, wrote gems, and felt that great vibe around beautiful
          and well-tested code. Ah yes… <strong>TDD</strong> and testing in
          general are absolutely cemented in the Ruby devs mindset.
        </p>
        <p>
          ...
          <strong>Java, PHP, Laravel, Python, Backbone.js, Sass, React</strong>,
          well you name it. As Software Engineers be prepared to learn different
          programming languages and frameworks, but with the experience, you
          will notice that standard computer science concepts and paradigms are
          still being applied every day.
        </p>
        <p>
          At that time{' '}
          <strong>
          ...
          , I felt mesmerized with what Node could be for the future web stack,
          and well it did! I coded and learned, in my free time, many concepts
          around streams, networking, callbacks, and web sockets. I recall as
          being a great experience that took me to the next level. Coming from
          Ruby, the Node community was distinctive, but at its genesis, they had
          the same open-source values and productive tools, plus everything was
          async! I was sold.
        </p>
        <p>
        ...
        <p>
          ...
          can be daunting. I assure you that after reading{' '}
          <a
          ...
          you’ll start to get it. Go read it, select the chapters that you most
          want to learn about,{' '}
          <a
            href="https://twitter.com/getify"
            target="_blank"
        ...
        <p>
          ...
          As an Engineer close to business decisions and building features that
          can impact the happiness of end-users and consequently product’s
          growth, I needed to get acquainted with the business domain I was
          working on. Knowing how to explain technical decisions to laymen,
          driving the communication, and how to push back a requirement when I
          saw associate risks involved, is paramount to succeed!
        </p>
        ...
        <p>
          ...
          communication, frustration with technology, low energy, or people not
          supporting your ideas, even with the best team available. Connecting
          the dots, emotional intelligence, and the culture you can nourish
          around you is what can make the difference in the end.
        </p>
        <p>
          With the experience acquired all over the years, I’m now regularly
          giving training to small to medium sized teams, mentoring CS students
          and was invited to teach in Northen Portugal Universities. Besides
          mentorship, I also act as a facilitator between the Development team
          and the Product Owner in order to build high-performance teams and
          excellent products.
        </p>
      </div>
      <div className="inner">
        ...
        <ul>
          ...
          <li>
            What do you think about &lt;<em>tech-name-here</em>&gt; ? Should we
            use it?
          </li>
          <li>
            We’re shipping software, but we carry over every Sprint. What should
            we do?
          </li>
      ...
      <div className="inner">
        ...
        <p>
          Ah! And every weekday, I’m available for a direct or remote 30-minute
          free session between 18:00-20:00 (GMT). Just contact me via{' '}
          <a
            href="mailto:davidgoncalvescunha@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
